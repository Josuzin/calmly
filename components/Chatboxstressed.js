...
const Chatbox = () => {
  ...
  const [theme, setTheme] = useState('theme-stressed');
      ...
      <div className="chatbox-input-container">
        <form onSubmit={handleSubmit} className="chatbox-form">
          <input
            ...
            className="chatbox-input-box-stressed"
          />
