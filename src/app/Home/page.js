  ...
  return (
    <>
      {mood === 0 ? (
        ...
        <HomePageHappy handleMood={handleMood} />
      ) : mood === 2 ? (
        <HomePageSad handleMood={handleMood} />
      ) : mood === 3 ? (
        <HomePageAngry handleMood={handleMood} />
      ) : mood === 4 ? (
        <HomePageStressed handleMood={handleMood} />
      ) : mood === 5 ? (
        <HomePageCalm handleMood={handleMood} />
      ) : (
        <HomePage handleMood={handleMood} />
      )}
    </>
